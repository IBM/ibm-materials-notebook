...
/**
 * Extracted relvant values from IToken of Cheverotain library
 * @deprecated
 */
export type CmdlToken = {
  /**
   * string of token image, e.g. record, graph, etc.
   */
  image: string;
  /**
   * type of token
  ...
  type: string;
  /**
   * start line of token (1-indexed)
   */
  startLine?: number;
  /**
   * end line of token (1-indexed)
   */
  endLine?: number;
  /**
   * column of first character (1-indexed)
   */
  startColumn?: number;
  /**
   * column of last character (1-indexed)
   */
  endColumn?: number;
  /**
   * offset of first character (0-indexed)
   */
  startOffset: number;
  /**
   * offset of last character (0-indexed). Points at last character.
   */
