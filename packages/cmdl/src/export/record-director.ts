...
//    dateCreated: Date
//  }
//  entities: Entity[] => declared/imported entity, alias, source, structure, components => flow reactors, polymers, etc...
//  files: File[]=> any imported char file
//  reactions: Reaction[]
//  flowReactions: FlowReaction[];
//  solutions: Solution[];
//  results: Result[] => sampleId => links to chardata, reaction role, reaction source
//  charData: CharData[]; => references to files.
//! samples: => deprecated, sampleId to be declared on char data
//  protocols: Protocols[];
// }
