...
export class ArrayHelper {
   ...
   */
  static equals(arrA: any[], arrB: any[]) {
   ...
   */
  static each(arr: any[], callback: any) {
    for (let i = 0; i < arr.length; i++) {
      callback(arr[i]);
    }
  }
   ...
   */
  static get(arr: any[], property: string | number, value: string | number) {
    for (let i = 0; i < arr.length; i++) {
   ...
   */
  static contains(arr: any[], options: any) {
   ...
   */
  static count(arr: any[], value: any) {
    let count = 0;
   ...
   */
  static removeAll(arrA: any[], arrB: any[]) {
   ...
   */
  static containsAll(arrA: any[], arrB: any[]) {
    let containing = 0;
    for (let i = 0; i < arrA.length; i++) {
      for (let j = 0; j < arrB.length; j++) {
        if (arrA[i] === arrB[j]) {
