...
export class CanvasWrapper {
  ...
  constructor(
    ...
    if (typeof target === "string" || target instanceof String) {
      this.canvas = document.getElementById(target as string);
    } else {
      this.canvas = target;
    }
  ...
  drawText(
    ...
    let r =
      dim.width > this.opts.fontSizeLarge ? dim.width : this.opts.fontSizeLarge;
    r /= 1.5;
