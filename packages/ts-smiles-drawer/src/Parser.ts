...
export default (function () {
  ...
  peg$SyntaxError.buildMessage = function (expected: any, found: any) {
    var DESCRIBE_EXPECTATION_FNS = {
      ...
      other: function (expectation: any) {
  ...
  function peg$parse(input: any, options?: any) {
    ...
    var peg$FAILED = {},
      ...
      peg$c64 = function (c: any) {
        return c;
      },
      peg$c65 = "+",
      peg$c66 = peg$literalExpectation("+", false),
      peg$c67 = function (c: any) {
        if (!c[1]) {
          return 1;
        }
        if (c[1] !== "+") {
      ...
      peg$c78 = function (c: any) {
        return Number(c[1][0] + c[1][1].join(""));
      },
      peg$c79 = function (i: any) {
    ...
    function peg$literalExpectation(text: any, ignoreCase: any) {
      return {
        type: "literal",
        text: text,
