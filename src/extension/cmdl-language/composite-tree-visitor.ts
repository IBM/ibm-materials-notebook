...
import { Group } from "./cmdl-tree/components/base-components";
import {
  NamedGroup,
  ReferenceGroup,
  VariableGroup,
...
export class CstRecordVisitor extends BaseVisitor {
  ...
  record(ctx: RecordCstChildren): CmdlTree {
  ...
  statement(ctx: StatementCstChildren, parent: Group) {
  ...
  importStatement(ctx: ImportStatementCstChildren, parent: CmdlTree) {
